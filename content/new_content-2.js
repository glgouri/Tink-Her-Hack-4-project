...
function blurYouTubePlayer(showName) {
  ...
  // ── KEY FIX ──────────────────────────────────────────────────────────────
  // Instead of appending inside YouTube's player DOM (where overflow:hidden
  // and stacking contexts clip the overlay), we measure the player's screen
  // position and attach a fixed-position overlay directly to document.body.
  // This guarantees it always appears on top regardless of YouTube's DOM.
  // ─────────────────────────────────────────────────────────────────────────
